...
from fourierninformer import FourierNiNformer
...
class FourierNiNformerImageClassification(FourierNiNformer):
    def __init__(
        self,
        image_size=32,
        patch_size=4,
...
model = FourierNiNformerImageClassification().to(device)
print(model)
...
logname = "/PATH/Fourier_NiNformer/Experiments_cifar10/logs_fourierninformer/logs_cifar10.csv"
...
path = "/PATH/Fourier_NiNformer/Experiments_cifar10/weights_fourierninformer"
model_name = "FourierNiNformerImageClassification_cifar10"
